...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= BASE_URL ?>/public/css/style.scss">
...
<body>
  <!-- Fixed navbar -->
  <nav id="menu" class="navbar navbar-default navbar-fixed-top navbar-custom">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?= BASE_URL ?>"><img src="<?= BASE_URL ?>/public/img/logo.jpg" alt="ECN Logo" /></a>
      </div>
      <div id="navbar" class="collapse navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><button type="button" class="btn btn-signup navbar-btn">Signup</button></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </nav>
